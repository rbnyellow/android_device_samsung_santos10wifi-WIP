...
#BOARD_SEPOLICY_UNION += domain.te surfaceflinger.te su.te
##BOARD_SEPOLICY_UNION += \
#
#ifneq ($(TARGET_BUILD_VARIANT),user,userdebug)
...
BOARD_EGL_CFG := $(LOCAL_PATH)/lib/egl/egl.cfg
...
# Custom Tools
#TARGET_RELEASETOOL_OTA_FROM_TARGET_SCRIPT := device/samsung/santos10wifi/releasetools/santos10wifi_ota_from_target_files
